...
disclosure:
  ...
  allowed_claims:
    - deployed beta / internal validation status
    - inherited early-boilerplate starting point and assigned-scope rebuild
    - personal backend, database, calculation-traceability, validation, testability, documentation, and AWS delivery work
    - collaboration with five TEA-SAF domain researchers and one frontend developer
    - separate five-person Airbus internal pilot context
    - generalized improvements to traceability, validation, testability, and release reliability
  excluded_claims:
    - sole authorship of the whole product
    - exact rollout size, user count, or geographic deployment claim
    - proprietary formulas, defaults, business logic, or calculation values
    - internal screenshots, copied diagrams, customer/stakeholder data, or internal identifiers
    - detailed security configuration, credentials, internal URLs, costs, or unapproved performance results
  maturity_boundary: Keep SAFAPAC described as a deployed beta/internal-validation platform.
sources:
