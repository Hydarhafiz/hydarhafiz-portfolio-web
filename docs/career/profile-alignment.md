# Recruiter-profile alignment package

This is the approved source for updating Hydar Hafiz bin Hydzelan's recruiter-facing LinkedIn and GitHub profiles. Copy the text blocks as written unless a platform requires a shorter field. Keep the phone number off both public profiles.
...
Use the LinkedIn title `Backend Software Developer (Contract)` and dates `November 2025 – Present`; retain `contract ending October 2026` in the description until the role ends.
...
Use the LinkedIn title `Web & Mobile Development Intern` and dates `January 2024 – August 2024`.

<!-- linkedin-petronas -->
```text
Web & Mobile Development Intern · January 2024 – August 2024

• Collaborated within a five-person project team on a MEAN/Ionic booking prototype used to introduce new staff and interns to the technology stack.
• Developed Angular data views and paired on Ionic booking, QR check-in, validation and Android deployment while documenting setup and development practices.
```
...
Enter these under Licenses & Certifications and use the supplied verification URLs:

1. AWS Certified Machine Learning Engineer – Associate — Amazon Web Services — March 2026 — https://www.credly.com/badges/7e465217-d4bb-4080-a529-259747407fa3/public_url
2. AWS Certified Cloud Practitioner — Amazon Web Services — September 2025 — https://www.credly.com/badges/b8964358-719b-4a4d-81c2-a0e1e6602550/public_url
3. Microsoft Certified: Azure AI Fundamentals — Microsoft — June 2025 — https://learn.microsoft.com/en-us/users/hydarhafizbinhydzelan-7550/credentials/255781426dc44f9c
...
Use this in a public `Hydarhafiz/Hydarhafiz` profile repository.
...
- [LinkedIn](https://www.linkedin.com/in/hydar-hafiz-356128233)
- [Email](mailto:shogunix.chan@gmail.com)
```
...
The project is actively developed. Evaluation gates, recommendation optimization, graph cleanup, cost controls and demo deployment remain active or future work. Public copy may describe implemented architecture and reliability controls, but must not claim demonstrated production maturity, a completed system or a live deployment.

The current public README opening uses unsupported production-maturity wording. Replace it with:

<!-- anothereden-readme-opening -->
```text
...
- [ ] Apply the approved profile bio and profile README.
- [ ] Replace AnotherEdenAI's unsupported production-maturity wording with the approved active-development opening.
...
Keep interview logistics out of public profile fields. When a recruiter asks, use:

<!-- recruiter-reply -->
```text
Thank you for reaching out. I am available to interview while completing my current contract, with Fridays generally offering the most flexibility. My earliest start date is in early November 2026, and I am open to hybrid, remote or on-site roles across Malaysia.
```
