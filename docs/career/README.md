...
The active software milestone remains governed by `docs/core/milestone.md`. During Milestone 7, `docs/content/portfolio-content-contract.md` is the sole human-approved authority for public career meaning and wording, while the milestone is the executable plan; this registry is supporting historical research and evidence context only. `.sdd/` remains reconstructable execution cache and must never be the only home of a durable claim decision.
